...
import XMonad.Util.SpawnOnce
   ...
   -- ColorScheme module (SET ONLY ONE!)
      -- Possible choice are from DTos are:
      -- DoomOne
      -- Dracula
      -- GruvboxDark
      -- MonokaiPro
...
myBrowser :: String
myBrowser = "opera"  -- Sets opera as browser
...
myWorkspaces = ["1: general", "2: dev", "3: sys", "4: doc", "4", "6", "7", "8", "9"]
...
myKeys c =
  ...
  , ("M-6", addName "Switch to workspace 5"    $ (windows $ W.greedyView $ myWorkspaces !! 4))
